		...
		if serializer.is_valid():
			...
			if j==0:
				...
				for i in range(0,len(serializer.data['request_list']),1):
					...
					payload = '{"to":"'+tmp.account.firebase_key+'","data":{},"notification":{"title":"Your request has been matched","body":"request_id:'+str(tmp.pk)+'","priority":"high","sound":"default"},}'
					#print(payload)
