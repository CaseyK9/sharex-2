...
class Get_Multiple_Matching(mixins.CreateModelMixin,
	...
	def create(self,request):
		...
		if serializer.is_valid():
			...
			payload = '{"to":"eYvP2nJtLXc:APA91bEPUWLpKCKeMLoGmrpbok3VJG73IgV4YWYCl6DwDfIgiVtRVBnq7MjKdIfGFYRoJdslchZ4XSH0wpn-JdRoZk-guVPJcGCeza3rZvPhSiTSkPGi7cgPVNRNKMjbiP-Kr_vC9hcG","data":{},"notification":{"title":"adf","body":"asdf","priority":"high","sound":"default"},}'
